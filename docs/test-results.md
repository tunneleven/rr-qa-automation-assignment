...
- **Execution window:** 2026-09-02 10:50:13–10:52:22 (UTC+07:00)
- **Environment:** Linux x86_64; Python 3.12.3; Playwright 1.62.0; Chromium `151.0.7922.34`
- **Command:** `uv run pytest -q --tb=short`
- **Duration:** 127.84 seconds (2 minutes 7 seconds)
- **Report:** `artifacts/report.html` (regenerated by this execution)
...
All planned non-defect scenarios passed. The 11 expected failures are strict regression checks for the six documented product defects.
